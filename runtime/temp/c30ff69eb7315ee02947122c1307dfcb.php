<?php /*a:1:{s:28:"F:\sheep\view\role\edit.html";i:1646060679;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo url('role/'.$data['id']); ?>" method="post" class="form-group ajax-form">
              <input type="hidden" name="__token__" value="<?php echo token(); ?>">
              <input type="hidden" name="_method"  value="put">
              <div class="form-group row">
                <label for="name" class="col-sm-2">角色名字</label>
                <input type="text" class="form-control col-sm-10" id="name" name="name" value="<?php echo htmlentities($data['name']); ?>"
                  placeholder="请输入角色名字" />
              </div>
              <div class="form-group row">
                ...
                <div class="clearfix col-sm-10">
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="statusOne" name="status" value="0" class="custom-control-input" <?php if(!$data['status']): ?>checked<?php endif; ?>>
                    <label class="custom-control-label" for="statusOne">停用</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="statusTwo" name="status" value="1" class="custom-control-input" <?php if($data['status']): ?>checked<?php endif; ?>>
                      ...
                      <td class="p-l-20">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" name="rules[]"
                            class="custom-control-input checkbox-parent checkbox-child" id="roleid-<?php echo htmlentities($v['id']); ?>"
                            dataid="id-<?php echo htmlentities($v['id']); ?>" value="<?php echo htmlentities($v['id']); ?>" <?php if(in_array($v['id'],$rule)): ?>checked<?php endif; ?>>
                      ...
                      <td class="p-l-40">
                        ...
                        <div class="custom-control custom-checkbox custom-control-inline">
                          <input type="checkbox" name="rules[]" class="custom-control-input checkbox-child"
                            id="roleid-<?php echo htmlentities($v['id']); ?>-<?php echo htmlentities($vr['id']); ?>" dataid="id-<?php echo htmlentities($v['id']); ?>-<?php echo htmlentities($vr['id']); ?>" value="<?php echo htmlentities($vr['id']); ?>" <?php if(in_array($vr['id'],$rule)): ?>checked<?php endif; ?>>
