<?php /*a:1:{s:30:"F:\sheep\view\admin\index.html";i:1646061975;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
                ...
                <div class="card">
                    <div class="card-toolbar d-flex flex-column flex-md-row">
                        <div class="toolbar-btn-action">
                            <a class="btn btn-primary m-r-5" onclick="openBox('添加菜单','<?php echo url('admin/create'); ?>',)"><i
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default ajax-think" href="javascript:void(0)"
                                                    onclick="openBox('编辑','<?php echo url('/admin/'.$v['id'].'/edit'); ?>',)"
                                                ...
                                                <a class="btn btn-xs btn-default ajax-post confirm"
                                                    href="<?php echo url('admin/' . $v['id']); ?>" title="" data-toggle="tooltip"
