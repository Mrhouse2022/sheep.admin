<?php /*a:1:{s:30:"F:\sheep\view\power\index.html";i:1646062029;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
                ...
                <div class="card">
                    <div class="card-toolbar d-flex flex-column flex-md-row">
                        <div class="toolbar-btn-action">
                            <a class="btn btn-primary m-r-5" onclick="openBox('添加菜单','<?php echo url('power/create'); ?>',)"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="children-plus children-plus-<?php echo htmlentities($v['id']); ?>" data-id="<?php echo htmlentities($v['id']); ?>">
                                        ...
                                        <td><?php echo htmlentities($v['control']); ?></td>
                                        <td class="text-center"><?php echo htmlentities($v['action']); ?></td>
                                        <td class="text-center">
                                            <?php if($v['url']): ?>
                                            <a href="<?php echo htmlentities($v['url']); ?>" target="_blank">访问</a>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php if($v['show']): ?>
                                        ...
                                        <td class="text-center"><?php echo htmlentities($v['sort']); ?></td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default ajax-think" href="javascript:void(0)"
                                                    onclick="openBox('编辑','<?php echo url('/power/'.$v['id'].'/edit'); ?>',)"
                                                ...
                                                <a class="btn btn-xs btn-default ajax-post confirm"
                                                    href="<?php echo url('power/' . $v['id']); ?>" title="" data-toggle="tooltip"
                                                    data-method="delete" data-original-title="删除"><i
                                                        class="mdi mdi-window-close"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php if(!empty($v['children'])): if(is_array($v['children']) || $v['children'] instanceof \think\Collection || $v['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vr): $mod = ($i % 2 );++$i;?>
                                    <tr class="children f-<?php echo htmlentities($v['id']); ?>">
                                        <td class="text-center"><?php echo htmlentities($vr['id']); ?></td>
                                        <td>|----<?php echo htmlentities($vr['name']); ?></td>
                                        <td><?php echo htmlentities($vr['control']); ?></td>
                                        <td class="text-center"><?php echo htmlentities($vr['action']); ?></td>
                                        <td class="text-center">
                                            <?php if($vr['url']): ?>
                                            <a href="<?php echo htmlentities($v['url']); ?>" target="_blank">访问</a>
                                            <?php endif; ?>
                                        ...
                                        <td class="text-center"><?php echo htmlentities($vr['sort']); ?></td>
                                        <td class="text-center"><?php echo htmlentities($vr['create_time']); ?></td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default ajax-think" href="javascript:void(0)"
                                                    onclick="openBox('编辑','<?php echo url('/power/'.$vr['id'].'/edit'); ?>',)"
                                                    title="" data-toggle="tooltip" data-method="put"
                                                    data-original-title="编辑"><i class="mdi mdi-pencil"></i></a>
                                                <a class="btn btn-xs btn-default ajax-post confirm"
                                                    href="<?php echo url('power/' . $vr['id']); ?>" title="" data-toggle="tooltip"
                                                    data-method="delete" data-original-title="删除"><i
                                                        class="mdi mdi-window-close"></i></a>
                                            </div>
                                        </td>
